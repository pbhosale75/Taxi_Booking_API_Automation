...
public class TC004_Get_One_Notification_Details extends TestBase{
    ...
    public static String notificationID;
	 ...
	 @BeforeClass
	    ...
	    @Test
	    public static void callRidesAPI() throws JSONException
	    {
 ...
 @Test
  public static void retrieveNotificationDetails() {
	  String Uid =UserID;
