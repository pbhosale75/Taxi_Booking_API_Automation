...
public class TC002_Post_ALL_Users extends TestBase{
	...
	@Test()
	 ...
	 json.put(excel.getData("Post_Req", 1, 2),excel.getData("Post_Req", 1, 3));
	 json.put(excel.getData("Post_Req", 2, 2),excel.getData("Post_Req", 2, 3));
	 json.put(excel.getCellData("Post_Req", 3, 2),excel.getCellData("Post_Req", 3, 3));
	 json.put(excel.getCellData("Post_Req", 4, 2),excel.getCellData("Post_Req", 4, 3));
